    ...
    <Form layout="vertical">
      <Form.Item label="① 建設用途 :">
        <Radio.Group className="flex flex-col">
          <Radio value="居住施設 | 集合住宅・複合住宅・別荘">
            居住施設 | 集合住宅・複合住宅・別荘
          </Radio>
          <Radio value="学校施設 | 学校・教育施設">
            学校施設 | 学校・教育施設
          </Radio>
          <Radio value="病院建築 | 総合病院・特殊病院・診療所">
            病院建築 | 総合病院・特殊病院・診療所
          </Radio>
          <Radio value="宗教的な建物 | 寺院仏閣・教会・葬祭場">
            宗教的な建物 | 寺院仏閣・教会・葬祭場
          </Radio>
          <Radio value="事務所等 | 事務所・オフィスビル・放送局">
            事務所等 | 事務所・オフィスビル・放送局
          </Radio>
          <Radio value="商業施設 | 商業建築・ホテル・宿泊施設">
            商業施設 | 商業建築・ホテル・宿泊施設
          </Radio>
          <Radio value="文化施設 | 地域交流施設・文化施設・ホール">
            文化施設 | 地域交流施設・文化施設・ホール
          </Radio>
          <Radio value="行政施設 | 公館・大使館・庁舎・裁判所・会議場">
            行政施設 | 公館・大使館・庁舎・裁判所・会議場
          </Radio>
          <Radio value="公共施設 | 郵便局・電話局・防衛施設・警察署・消防署">
          ...
          <Radio value="宿泊施設 | ホテル・保養所・旅館">
            宿泊施設 | ホテル・保養所・旅館
          </Radio>
          <Radio value="展示施設 | 美術館・博物館・資料館・記念館">
            展示施設 | 美術館・博物館・資料館・記念館
          </Radio>
          <Radio value="工場施設 | 工場">工場施設 | 工場</Radio>
          <Radio value="交通ビル | 駐車場・サービスエリア・空港ビル・バスターミナル">
          ...
          <Radio value="スポーツ施設 | 競技場・野球場・体育館・武道場・プール・総合体育施設">
